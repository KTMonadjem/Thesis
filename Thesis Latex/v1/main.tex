...
% Run-time enforcer smaller example
% Esterel not use ABRO, use with C functions
% WCET analysis
...
% Remove new definitions - use only SNN and MNN
% 1) Intro
% 2) VDTA and cite DTA
% 2.1) Edits
% 2.2) Soundness, etc
% 3) Case study
% 4) Results
% Consistent diagram font size
% Redo RE diagram with input enforcer


% GENERAL
% Chapter end - discussions, not conclusions; compare with related work
% Look Euegen Yip's thesis
% Acknowledge non-created pictures
