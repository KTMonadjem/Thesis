...
An example \ac{DTA} is given in Example~\ref{ex:dta}.
...
\begin{example}[Syntax of a \ac{DTA}]\label{ex:dta}
	...
	While A and B are present simultaneously, transition back to the safe state.\\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{avdta.tikz}
