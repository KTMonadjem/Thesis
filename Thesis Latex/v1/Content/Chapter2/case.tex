...
\begin{table}[h]
	...
	\begin{tabular}{|p{0.25\textwidth}|p{0.1\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|}
		\hline
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{avcarrte.tikz}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{avdriverte.tikz}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{avcnnrte.tikz}
