\section{Simulating an Traffic Sign Recognition AV System}
...
The system's sensors included an overhead, 360$^\circ$ \acf{LiDAR} apparatus, and a single, frontal facing camera.
