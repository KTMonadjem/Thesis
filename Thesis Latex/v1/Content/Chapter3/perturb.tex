...
Additionally, to reduce the impact of perturbations to the \ac{CNN}'s inputs, the \ac{SNN} used in the system is actually a \ac{MNN} composed of three \ac{MNN} ensembles, each with three synchronous \acp{CNN}.
