...
\path[->] 
		...
		{
			\scriptsize$\let\scriptstyle\textstyle\substack{\Big((B_H~\&~(O_2~=~C))~|\\~(B_S~\&~(O_5~=~C))~\&\\~(S~>~O_{2_S}~|~S~>~O_{5_S})~|\\~A~\&~(O_4~=~C)~\&~S~<~O_{4_S}\Big)}$
		} (A)
	
		(A) edge [right]	node [below]  
		{
			\scriptsize$\let\scriptstyle\textstyle\substack{\sum\textbackslash \Big((B_H~\&~(O_2~=~C))~|~(B_S~\&~(O_5~=~C))~\&\\~(S~>~O_{2_S}~|~S~>~O_{5_S})~|\\~A~\&~(O_4~=~C)~\&~S~<~O_{4_S}\Big)}$
		} (C)
