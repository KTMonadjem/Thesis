\section{Timing Analysis of \acp{SANN}}
\label{sec:wcrt}
...
%\changed{Consequently, this work is restricted to the single-core Patmos architecture and does not examine execution of \acp{SANN} on other platform types, such as Intel processors or GPUs}.
...
%This section discusses the WCRT analysis of SANNs.
