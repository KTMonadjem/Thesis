...
In \ac{CPS}, it is essential for all components to be verified and validated, and thus the issue with \ac{AI} in \ac{CPS} is made clear: \ac{AI} don't have the necessary verification and validation techniques to be used in \ac{CPS}.
...
In this thesis, a new \ac{ANN} library was created to prove the benefits of synchronous \acp{ANN}.
